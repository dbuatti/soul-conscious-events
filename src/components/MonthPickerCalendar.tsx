...
import { DayPicker, ClassNames, DayPickerProps } from 'react-day-picker'; // Import DayPickerProps
...
const MonthPickerCalendar: React.FC<MonthPickerCalendarProps> = ({
  ...
  } as any; // Cast to any to bypass strict type checking for ClassNames

  return (
    <DayPicker
      {...{
        mode: "single",
        view: "month", // Explicitly set view to month
        selected: selected,
        onSelect: onSelect,
        defaultMonth: defaultMonth,
        className: cn("p-3", className),
        classNames: {
          ...(defaultDayPickerClassNames as ClassNames), // Cast back to ClassNames when spreading
          ...classNames,
        },
        components: {
      ...
      } as DayPickerProps} // Cast the entire props object to DayPickerProps
    />
  );
};

...
const HeaderV2 = () => {
  ...
  const adminNavItems: NavItem[] = [
    { to: "/admin/panel", label: "Admin Panel", icon: UserCog }, // Updated path
    { to: "/dev-space", label: "Dev Space", icon: UserCog }, // Updated path
    { to: "/map", label: "Map", icon: UserCog }, // Updated path
  ];
    ...
    <header className="w-full bg-primary py-3 px-4 md:px-8 flex justify-center sticky top-0 z-50">
      <div className="w-full max-w-2xl flex justify-between items-center">
        <Link to="/" className="flex flex-col items-start text-primary-foreground hover:text-primary-foreground/80 transition-colors">
          <span className="text-2xl font-bold leading-none font-heading">SoulFlow</span> {/* Applied font-heading */}

...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-foreground text-muted py-8 px-6 md:px-8 shadow-inner">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-muted-foreground pb-8 mb-8">
        {/* Section 1: About */}
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-primary-foreground">SoulFlow</h3>
        ...
        <div className="space-y-4">
          ...
          <nav className="flex flex-col space-y-2">
            ...
            <Link to="/calendar" className="hover:text-primary transition-colors text-sm">Calendar</Link>
            ...
            <Link to="/admin/panel" className="hover:text-accent-foreground transition-colors text-sm">Admin Panel</Link>
          </nav>
        </div>

        {/* Section 3: Connect & Support */}
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-primary-foreground">Support Us</h3>
          <a
      ...
      {/* Bottom Bar */}
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">

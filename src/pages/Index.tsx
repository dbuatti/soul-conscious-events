      ...
      <div className="mb-8 p-6 border border-gray-200 rounded-lg bg-gray-50 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 items-start">
          ...
          <div className="relative col-span-full">
            ...
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-500 mt-1" /> {/* Adjusted mt-1 */}
            <Input
              id="search-events"
      ...
      {loading ? (
        ...
        <>
          {viewMode === 'list' ? (
            ...
            <EventCalendar
              events={events}
              selectedDate={selectedCalendarDate} // Corrected prop name

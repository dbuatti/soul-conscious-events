...
import { PlusCircle, Lightbulb, Zap, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button onClick={() => setIsAddDialogOpen(true)} className="bg-primary hover:bg-primary/80 text-primary-foreground">
